# Capital report — daily deposits into Total Capital (2026-09-20)

**Definitions.** *Total Capital (live)* = principal $1900.00 + realized $1300.76 + open mark-to-market $689.17 = **$3889.93** — the Overview's own stat, so it moves with marks and can fall without a trade closing. *Daily deposit* = the capital added on a local calendar day = that day's **booked** PnL (finished trades, booked at `closedAt ?? resolvedAt`) + any **ledger injection**. This report and the chart on `/capital` are the same `src/lib/capital.ts` series.

## Window

- Window: **2026-08-22 → 2026-09-20** (30 local days)
- Opening booked capital: **$1754.80** (`opening` ledger entry $1900.00 dated 2026-07-22)
- Deposits in window: **+$1445.96** = booked +$1445.96 + injected +$0.00
- Closing booked capital: **$3200.76** · peak close $3373.17 on 2026-09-18
- Up days 12 · down days 15 · flat 3 · longest up-run 3 (current 0)
- Open positions excluded from every row: notional $961.66, unrealized +$689.17

## Daily deposits (same numbers as the /capital chart)

| day | deposit | booked | closing |
|---|---|---|---|
| 2026-09-20 | -$154.37 | -$154.37 | $3200.76 |
...
| 2026-08-22 | -$4.57 | -$4.57 | $1750.23 |
| **total** | **+$1445.96** | **+$1445.96** | **$3200.76** |

## Best / worst days

- Best: 2026-09-18 +$993.70 · 2026-09-16 +$743.38 · 2026-09-07 +$276.93 · 2026-09-12 +$272.80 · 2026-08-29 +$206.78
- Worst: 2026-09-14 -$229.46 · 2026-09-20 -$154.37 · 2026-09-11 -$136.59 · 2026-09-15 -$119.50 · 2026-08-30 -$116.41
...
npx tsx scripts/capital-deposits-report.ts --days=30 --write  # + drafts/capital-deposits-2026-09-20.md
