# Capital report — daily deposits into Total Capital (2026-09-22)

**Definitions.** *Total Capital (live)* = principal $1900.00 + realized $2381.05 + open mark-to-market $327.39 = **$4608.44** — the Overview's own stat, so it moves with marks and can fall without a trade closing. *Daily deposit* = the capital added on a local calendar day = that day's **booked** PnL (finished trades, booked at `closedAt ?? resolvedAt`) + any **ledger injection**. This report and the chart on `/capital` are the same `src/lib/capital.ts` series.

## Window

- Window: **2026-08-24 → 2026-09-22** (30 local days)
- Opening booked capital: **$1753.04** (`opening` ledger entry $1900.00 dated 2026-07-22)
- Deposits in window: **+$2528.01** = booked +$2528.01 + injected +$0.00
- Closing booked capital: **$4281.05** · peak close $4281.05 on 2026-09-22
- Up days 13 · down days 14 · flat 3 · longest up-run 3 (current 2)
- Open positions excluded from every row: notional $452.95, unrealized +$327.39

## Daily deposits (same numbers as the /capital chart)

| day | deposit | booked | closing |
|---|---|---|---|
| 2026-09-22 | +$739.04 | +$739.04 | $4281.05 |
...
| **total** | **+$2528.01** | **+$2528.01** | **$4281.05** |

## Best / worst days

- Best: 2026-09-18 +$993.70 · 2026-09-16 +$743.38 · 2026-09-22 +$739.04 · 2026-09-21 +$337.02 · 2026-09-07 +$276.93
...
npx tsx scripts/capital-deposits-report.ts --days=30 --write  # + drafts/capital-deposits-2026-09-22.md
